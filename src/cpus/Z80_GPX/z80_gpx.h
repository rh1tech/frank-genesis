...
/* Forward declaration for daisy chain (not used in Genesis) */
...
extern void z80_gpx_init(const void *config, int (*irqcallback)(int));
extern void z80_gpx_reset(void);
extern void z80_gpx_run(unsigned int cycles);
extern void z80_gpx_get_context(void *dst);
extern void z80_gpx_set_context(void *src);
extern void z80_gpx_set_irq_line(unsigned int state);
extern void z80_gpx_set_nmi_line(unsigned int state);

/* Get current cycle count */
extern unsigned int z80_gpx_get_cycles(void);
